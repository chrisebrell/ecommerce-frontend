...
export default function CartPage() {
  // Destructure meths+props from cartContext
  ...
  // useEffect hook product details fetch
  useEffect(() => {
  ...
  }, [name, email, address, city, state, zip, cardholder, cvc, exp, cc]);
  ...
  //functions to add item/remove items (rem -> cartContext)
  function addItem(id) {
    addProduct(id);
  }
            ...
            <div className="rounded-sm bg-gray-600 border-gray-500 p-8">
              {!!cartProducts?.length && (
                <div className="text-black">
                  ...
                  <h2 className="text-white text-center text-md mt-2 mb-4">
                    Payment Information
                  </h2>
                  <Form
                    type="text"
                  ...
                  <button
                    onClick={(setOrderSuccess, placeOrder)}
