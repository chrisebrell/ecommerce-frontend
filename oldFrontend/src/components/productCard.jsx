...
const ProductCard = ({ product }) => {
  ...
  const defaultImage =
    product.images[0] ||
    "https://ecommerce-group6.s3.amazonaws.com/1711212204953.jpeg";
  ...
  return (
    <>
      <div className="product-card-container">
        ...
        <button className="button-container" onClick={addProductToCart}>
          Add to Cart
        </button>
        <Link to="/description" state={{ product: product, defaultImage }}>
